...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'JavaScript Essentials', collapsed: true, items: [{ autogenerate: { directory: 'js-essentials' } }] },
        { label: 'Event Loop & Async', collapsed: true, items: [{ autogenerate: { directory: 'event-loop-async' } }] },
        { label: 'Core APIs', collapsed: true, items: [{ autogenerate: { directory: 'core-apis' } }] },
        { label: 'Streams & I/O', collapsed: true, items: [{ autogenerate: { directory: 'streams' } }] },
        { label: 'HTTP & Networking', collapsed: true, items: [{ autogenerate: { directory: 'http-networking' } }] },
        { label: 'Modules & npm', collapsed: true, items: [{ autogenerate: { directory: 'modules-npm' } }] },
        { label: 'Testing & Tooling', collapsed: true, items: [{ autogenerate: { directory: 'testing-tooling' } }] },
      ],
      }), preact()],
});